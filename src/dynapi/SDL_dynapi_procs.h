...
SDL_DYNAPI_PROC(int,SDL_GetRealtimeClock,(SDL_TimeSpec *a),(a),return)
SDL_DYNAPI_PROC(int,SDL_TimeSpecToUTCDateTime,(const SDL_TimeSpec *a, SDL_DateTime *b),(a,b),return)
SDL_DYNAPI_PROC(int,SDL_TimeSpecToLocalDateTime,(const SDL_TimeSpec *a, SDL_DateTime *b),(a,b),return)
SDL_DYNAPI_PROC(int,SDL_FileTimeToUTCDateTime,(Sint64 a, SDL_DateTime *b),(a,b),return)
SDL_DYNAPI_PROC(int,SDL_FileTimeToLocalDateTime,(Sint64 a, SDL_DateTime *b),(a,b),return)
SDL_DYNAPI_PROC(int,SDL_DateTimeToTimeSpec,(const SDL_DateTime *a, SDL_TimeSpec *b),(a,b),return)
SDL_DYNAPI_PROC(int,SDL_DateTimeSetDayOfWeekAndDayOfYear,(SDL_DateTime *a),(a),return)
SDL_DYNAPI_PROC(SDL_bool,SDL_DateTimeIsValid,(const SDL_DateTime *a),(a),return)
SDL_DYNAPI_PROC(int,SDL_FormatDateTime,(char *a, size_t b, const char *c, const SDL_DateTime *d),(a,b,c,d),return)
SDL_DYNAPI_PROC(int,SDL_TimeSpecDiff,(SDL_TimeSpec *a, const SDL_TimeSpec *b, const SDL_TimeSpec *c),(a,b,c),return)
SDL_DYNAPI_PROC(Sint64,SDL_TimeSpecDiffNS,(const SDL_TimeSpec *a, const SDL_TimeSpec *b),(a,b),return)
