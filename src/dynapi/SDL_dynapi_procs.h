...
SDL_DYNAPI_PROC(int, SDL_GetWindowHDRProperties,(SDL_Window *a, SDL_HDROutputProperties *b),(a,b),return)
SDL_DYNAPI_PROC(int, SDL_GetDisplayHDRProperties,(SDL_DisplayID a, SDL_HDROutputProperties *b),(a,b),return)
