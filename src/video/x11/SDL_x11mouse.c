...
static Cursor X11_CreateAnimatedXCursorCursor(SDL_AnimatedCursorFrame *frames, int num_frames, int hot_x, int hot_y)
{
    Display *display = GetDisplay();
    Cursor cursor = None;
    XcursorImage *image;
...
static SDL_Cursor *X11_CreateAnimatedCursor(SDL_AnimatedCursorFrame *frames, int num_frames, int hot_x, int hot_y)
{
    Cursor x11_cursor = None;
