...
SDL_X11_SYM(int,XkbSelectEvents,(Display* a, unsigned int b, unsigned int c, unsigned long d))
SDL_X11_SYM(int,XkbSelectEventDetails,(Display* a, unsigned int b, unsigned int c, unsigned long d, unsigned long e))
