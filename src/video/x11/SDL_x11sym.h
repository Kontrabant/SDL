...
SDL_X11_SYM(Status, XIGrabDevice,(Display *dpy, int deviceid, Window grab_window, Time time, Cursor cursor, int grab_mode, int paired_device_mode, Bool owner_events, XIEventMask *mask))
SDL_X11_SYM(Status, XIUngrabDevice,(Display *dpy,int deviceid,Time time))
