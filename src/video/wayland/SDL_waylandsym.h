...
SDL_WAYLAND_SYM(void, wl_array_init, (struct wl_array *))
SDL_WAYLAND_SYM(void, wl_array_release, (struct wl_array *))
SDL_WAYLAND_SYM(void *, wl_array_add, (struct wl_array *, size_t))
