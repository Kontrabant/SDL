...
typedef struct Wayland_EventThreadContext
{
...
extern struct wl_proxy *Wayland_CreateEventThreadProxyWrapper(Wayland_EventThreadContext *context, void *obj);
