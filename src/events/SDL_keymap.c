...
{
    // The modifiers that affect the keymap are: SHIFT, CAPS, ALT, MODE, and MOD3
    modstate &= (SDL_KMOD_SHIFT | SDL_KMOD_CAPS | SDL_KMOD_ALT | SDL_KMOD_MODE | SDL_KMOD_XKB_MOD3);
