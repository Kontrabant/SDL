...
extern char sdl_tz_name[2][128];
extern SDL_Mutex *sdl_tz_lock;

extern int SDL_InitTime(void);
extern void SDL_QuitTime(void);

extern void SDL_UpdateTZNames(void);
...
/* Checks if all members of an SDL_DateTime struct are within valid ranges. */
extern SDL_bool SDL_DateTimeIsValid(const SDL_DateTime *dt);
